	...
	implements MouseListener 
{
	...
	private Shell add_wms_shell,add_control_shell,edit_center_shell,create_boxes_shell;
	
	private Display display;
	private Button open_add_wms_shell_btn,open_set_center_btn,open_add_control_btn,open_create_boxes_btn;
	...
	private Button add_wms_btn,add_control_btn,set_center_btn,load_wms_example,create_boxes_btn ;
	...
	public void showCreateBoxesShell() {
		...
		l.setFont(boldFont);
		l.setText("X-Count");
		boxes_x_count_field=new Text(create_boxes_shell,SWT.NONE | SWT.BORDER);
		l=new Label(create_boxes_shell,SWT.NONE);
		l.setFont(boldFont);
		l.setText("Y-Count:");

		//new Label(add_wms_shell,SWT.NONE).setText("Layers:");
		boxes_y_count_field=new Text(create_boxes_shell,SWT.NONE | SWT.BORDER);
